...
<head>
    ...
    <title>CatWebp | Free WebP Converter</title>
    <meta name="description" content="Convert your images to WebP format for free with CatWebp. No more troubleshooting, just fast and efficient conversion.">
    <meta name="keywords" content="webp converter, image conversion, catwebp, image format, franka store, free converter, webp format">   
    <meta name="author" content="catwebp">
    <meta property="og:title" content="CatWebp | Free WebP Converter">
    <meta property="og:description" content="Convert your images to WebP format for free with CatWebp. No more troubleshooting, just fast and efficient conversion.">
    <meta property="og:image" content="url-to-your-social-media-thumbnail-image.jpg">
    <meta property="og:url" content="https://catwebp.franka.store">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="CatWebp | Free WebP Converter">
    <meta name="twitter:description" content="Convert your images to WebP format for free with CatWebp. No more troubleshooting, just fast and efficient conversion.">
    <meta name="twitter:image" content="/apple-touch-icon.png">
    <link rel="icon" href="/apple-touch-icon.png" type="image/png">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <link rel="canonical" href="https://catwebp.franka.store">
    <script type="application/ld+json">
{
  "@context": "http://schema.org",
  "@type": "Organization",
  "name": "CatWebp",
  "url": "https://catwebp.franka.store",
  "logo": "url-to-your-logo.png",
  "description": "Convert your images to WebP format for free with CatWebp. No more troubleshooting, just fast and efficient conversion.",
  "serviceType": "Image format conversion",
  "aggregateRating": {
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-3">
                       ...
                       <li data-bs-toggle="collapse" data-bs-target="#navbarNav" class="nav-item">
                            <a class="nav-link active" href="#" onclick="loadIframe('postore.php', this);"><span class="p-1 fw-light  text-light"><i class="bi bi-grid"></i></span> WEBP Image Converter</a>
                        </li>
                        
                         <li data-bs-toggle="collapse" data-bs-target="#navbarNav" class="nav-item">
                            <a class="nav-link" href="#" onclick="loadIframe('postore.php', this);"><span class="p-1 fw-light  text-light"><i class="bi bi-grid"></i></span> CatPosting</a>
                        </li>
                        
                             
                          <li data-bs-toggle="collapse" data-bs-target="#navbarNav" class="nav-item">
                            <a class="nav-link" href="#" onclick="loadIframe('messaging.php', this);"><span class="p-1 fw-light  text-light"><i class="bi bi-grid"></i></span> CatMessaging</a>
                        </li>
                    ...
                    <iframe id="iframeContent" src="https://franka.store/app/php/img-converter.php" class="bg-body-tertiary rounded-bottom-0" frameborder="0"></iframe>
