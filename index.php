...
<body>
    <div class="modal fade" id="appModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <nav class="w-100 z-index navbar position-fixed top-0 shadow navbar-expand-lg bg-custom" data-bs-target="#navbarNav" aria-controls="navbarNav">
            <div class="container-xl">
                <a class="navbar-brand" href="#">Frankastore®</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-3">
                        <li data-bs-toggle="collapse" data-bs-target="#navbarNav" class="nav-item">
                            <a class="nav-link" href="#" onclick="loadIframe('home.php', this);">Home</a>
                        </li>
                        <li data-bs-toggle="collapse" data-bs-target="#navbarNav" class="nav-item">
                        ...
                        <li data-bs-toggle="collapse" data-bs-target="#navbarNav" class="nav-item">
                            <a class="nav-link" href="#" onclick="loadIframe('easypost.php', this);"><span class="p-1 fw-light  text-success"><i class="bi bi-download"></i></span> Easypost</a>
                        </li>
                        <li data-bs-toggle="collapse" data-bs-target="#navbarNav" class="nav-item">
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content bg-transparent">
                <div class="modal-body p-0">
                    <iframe id="iframeContent" src="app/php/home.php" class="bg-body-tertiary rounded-bottom-0" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function updateIframeSource(page) {
            document.getElementById('iframeContent').src = '/app/php/' + page;
        }
