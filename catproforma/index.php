...
<head>
    ...
    <title>CatProforma | Professional Invoicing Software</title>
    <meta name="description" content="Create professional invoices easily with CatProforma. Streamline your billing process and get paid faster.">
    <meta name="keywords" content="invoicing software, professional invoices, billing software, catproforma, invoice generation, franka store">
    <meta name="author" content="catproforma">
    <meta property="og:title" content="CatProforma | Professional Invoicing Software">
    <meta property="og:description" content="Create professional invoices easily with CatProforma. Streamline your billing process and get paid faster.">
    <meta property="og:image" content="url-to-your-social-media-thumbnail-image.jpg">
    <meta property="og:url" content="https://catproforma.franka.store">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="CatProforma | Professional Invoicing Software">
    <meta name="twitter:description" content="Create professional invoices easily with CatProforma. Streamline your billing process and get paid faster.">
    <meta name="twitter:image" content="/apple-touch-icon.png">
    <link rel="icon" href="/apple-touch-icon.png" type="image/png">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <link rel="canonical" href="https://catproforma.franka.store">
    <script type="application/ld+json">
{
  "@context": "http://schema.org",
  "@type": "Organization",
  "name": "CatProforma",
  "url": "https://catproforma.franka.store",
  "logo": "url-to-your-logo.png",
  "description": "Create professional invoices easily with CatProforma. Streamline your billing process and get paid faster.",
...
<body>
    ...
    <nav class="w-100 z-index navbar position-fixed top-0 shadow navbar-expand-lg bg-custom" data-bs-target="#navbarNav" aria-controls="navbarNav">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-3">
                           <li data-bs-toggle="collapse" data-bs-target="#navbarNav" class="nav-item">
                            <a class="nav-link active" href="#" onclick="loadIframe('proforma.php', this);"><span class="p-1 fw-light  text-light"><i class="bi bi-grid"></i></span> Proforma Template</a>
                        </li>
       ...
       <iframe id="iframeContent" src="https://franka.store/app/php/proforma.php" class="bg-body-tertiary rounded-bottom-0" frameborder="0"></iframe>
